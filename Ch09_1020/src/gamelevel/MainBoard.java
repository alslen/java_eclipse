...
public class MainBoard {
	...
	public static void main(String[] args) {
		...
		// Player는 이 클래스 안에, 추상클래스(부모클래스) PlayerLevel를 참조형 변수 level 선언.
		// has A 관계로 사용한다.
		// Player 디폴트 생성자에, 기본 BeginnerLevel 인스턴스가 생성이 된다.
		// 그리고 각 자식 클래스 3개가 있음. BeginnerLevel,AdvancedLevel,SuperLevel
...
//		public abstract void showLevelMessage();
		...
		//level= new BeginnerLevel(); 사용했습니다.

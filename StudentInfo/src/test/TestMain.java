...
public class TestMain {
	...
	// 스쿨 클래스 형은 하나의 객체만 사용한다. 싱글톤 패턴으로 하나의 인스턴스만 사용한다.
	...
	public void createSubject2() throws FileNotFoundException{
		...
		while(scanner.hasNext()) {
			...
			if(subjectFirstSpell.equals("K")) {
				...
				dance.setGradeType(Define.PF_TYPE);  // 학생 평가 정책 지정
	...
	public void creatSubject(){
		...
		// 방송과목 추가 및 성적 평가는 70점이상 이면 Pass 평가 방식 채택.
	...
	public void createStudent(){
		...
		// 학생 추가 요구 시 아래에 추가하기. 본인이름으로, 학번은 221102, 이혜진, 컴퓨터(과목 추가 예정), 지금은 방송대스로 임시추가.
		...
		Student student6 = new Student(221102, "이혜진", dance );

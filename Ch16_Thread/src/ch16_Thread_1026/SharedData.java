...
public class SharedData {
   ...
   public synchronized void up (String name){  // up()메서드가 동작을 다 하고 down()메서드가 동작함
      ...
      data++;
      System.out.println( "를 "+ data +" 로 증가시킴_up 메서드 수행을 보장 받았음.");
   }
   public synchronized void down (String name){
      ...
      System.out.print( name +"이 "+ data );
      data--;
      System.out.println( "을 "+ data +" 로 감소시킴_down 메서드 수행을 보장 받았음.");
   }
}